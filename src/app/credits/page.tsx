    ...
    <div className="bg-[#fafaf8] text-[#1a1a1a]">
      ...
      <section className="pt-36 pb-24 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <a href="#contact" className="inline-flex items-center gap-2 text-[#c27c3e] font-medium hover:text-[#a5662f] transition">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-4 gap-10 mb-16">
            <div className="md:col-span-2">
              <div className="text-white font-bold text-lg mb-4 tracking-tight">base<span className="text-[#c27c3e]">261</span></div>
